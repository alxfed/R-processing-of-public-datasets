...
#Let's uniry the names a little bit
...
Let's calculate the relative Humidity from the Temperature.Dewpoint and vise-versa. But first - let's look:
...
Now everything is ok. The missinf value was in the Measurement.Timestamp, not in the Temperature.